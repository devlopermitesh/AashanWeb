...
export const ProductGridBlock: Block = {
  ...
  fields: [
    //add a default Type
    {
      ...
      type: 'select',
      required: true,
      defaultValue: 'productgrid',
      options: [{ label: 'Products Show', value: 'productgrid' }],
      admin: {
        readOnly: true,
      },
    },
    //variant for describing the versions
    {
      name: 'variant',
      type: 'text',
      defaultValue: 'default',
    },
    //disable check for control visiblity
    {
      name: 'disabled',
      type: 'checkbox',
      defaultValue: false,
        ...
        // ===== LAYOUT SETTINGS =====
        {
          ...
          fields: [
            ...
            // ===== GRID SPECIFIC SETTINGS =====
            {
              ...
              admin: {
                condition: (_data, siblingData) => siblingData?.type === 'grid',
            ...
            // ===== CAROUSEL SPECIFIC SETTINGS =====
            {
              ...
              admin: {
                condition: (_data, siblingData) => siblingData?.type === 'carousel',
...

            {
              ...
              admin: {
                condition: (_data, siblingData) =>
                  siblingData?.type === 'carousel' && siblingData?.carouselAutoScroll,
            ...
            // ===== CARD STYLE GROUP =====
            {
              ...
              fields: [
...

                {
                  ...
                  defaultValue: '#e5e5e5',
                  admin: {
                    condition: (_data, siblingData) => siblingData?.showBorder,
                    components: {
                      Field: '@/modules/admin/ui/colorpicker#ColorPicker',
                    },
            ...
            // ===== PRICE =====
            {
              ...
              fields: [
...

                {
                  ...
                  admin: {
                    condition: (_data, siblingData) => siblingData?.show,
                  },
                },
              ],
            },
            ...
            // ===== ADD TO CART =====
            {
              ...
              fields: [
...

                {
                  ...
                  admin: {
                    condition: (_data, siblingData) =>
                      siblingData?.show && siblingData?.style !== 'icon',
                  },
                },
              ],
            },
        ...
        // ===== PAGINATION =====
        {
          ...
          fields: [
...

            {
              ...
              admin: {
                condition: (_data, siblingData) =>
                  siblingData?.type !== 'none' && siblingData?.type !== 'infinite-scroll',
...

            {
              ...
              maxLength: 30,
              admin: {
                condition: (_data, siblingData) => siblingData?.type === 'load-more',
              },
            },
          ],
        },
